...
class ModelConfig:
    ...
    DETECT_TONE_CONFIG = types.GenerateContentConfig(
        ...
        - and 3 quick, context-appropriate reply suggestions the user could send in response to the message.
       ...
       - "Can you please respond ASAP? This is important." → {
         "original_message": "Can you please respond ASAP? This is important.",
         "tone": "neutral",
        ...
        "original_message": "Hey, just checking in about the meeting next week.",
        "tone": "neutral",
...
def detect_tone(text: str) -> dict:
    ...
    if json_str:
        try:
            ...
            # Attach the original message directly
            response_dict["original_message"] = text.strip()
